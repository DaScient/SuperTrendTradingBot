...
A [DaScient Capital, LP](https://dascientcapital.us) proprietary program &amp; non-ML approach to the application of the SuperTrend, as well as, other technical indicators leveraged to execute buy &amp; sell orders to both Robinhood & Binance.US cryptocurrency exchanges using python.
