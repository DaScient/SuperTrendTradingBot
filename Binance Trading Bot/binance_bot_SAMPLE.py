...
ticker=tick+"/USDT"
timeframe = "5m"
order_size = 10000000 #About $70 worth of SHIB
in_position = False #This tells the bot that you want to buy at the next opportunity.
min_sell_price=0.000007 
prev_purch_price=min_sell_price
perc=.2
markup=1+perc/100
max_loss=.2
volatility=0.333333333333333333333333333333333333333333333333333333
